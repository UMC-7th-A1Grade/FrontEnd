...
//   return (
//     <main className={styles.layout}>
//       <div className={styles.layout__header_container}>
//         <div className={styles.layout__chatbotButton}>
//           <ChatbotButton />
//         </div>
//         <header className={styles.layout__header}>
//           <img
...
//           />
//         </header>
//         <div className={styles.layout__creditButton}>
//           <CreditButton />
//         </div>
//       </div>
...
//       <section className={styles.layout__message}>
//         <SemicircleMessage />
//       </section>
...
//       <section className={styles.layout__buttons_container}>
//         <div className={styles.layout__random_section}>
//           <RandomQuestionButton />
//           <p className={styles.review_text}>
//             문제를 클릭해서 나의 복습을 확인해보세요!
//           </p>
...
//         <div className={styles.layout__button_grid}>
//           <div className={styles.layout__myButton}>
//             <LinkMyPageButton />
//           </div>
//           <div className={styles.layout__CameraButton}>
//             <LinkCameraButton />
//           </div>
//           <div className={styles.layout__storagebutton}>
//             <LinkStorageButton />
//           </div>
//         </div>
//       </section>
...
//       <footer className={styles.layout__footer}>
//         <p className={styles.layout__representative}>대표자 : 이진동</p>
//         <Link to="/terms" className={styles.layout__terms}>
//           이용약관
//         </Link>
//         <Link to="/privacy" className={styles.layout__privacy}>
//           개인정보처리방침
//         </Link>
//       </footer>
